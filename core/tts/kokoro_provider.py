...
class KokoroTTSProvider(TTSProvider):
    ...
    def __init__(self, lang_code: Optional[str] = None, sample_rate: int = DEFAULT_SAMPLE_RATE):
        ...
        self._pipelines: Dict[str, "object"] = {}  # lazily built, keyed by lang_code, reused across calls

    def _get_pipeline(self, lang_code: str):
        from kokoro import KPipeline  # heavy import -- deferred until actually needed
    ...
    def synthesize(self, text: str, language: str, voice: str, out_path: Path) -> Path:
        ...
        try:
            ...
            # killed process never leaves a corrupt file that is_cached()
